...
const AboutBody = () => {
  return (
    <div className="text-center pl-5 pr-5 mb-3 about-text">
      <h1 className="pt-1 pb-2">About</h1>
      <p>
        Yale University’s namesake is Elihu Yale, a slave trader and
        the governor of the British East India Company responsible for
        over a century of colonial rule in India. This Critical
        ...
        present-day and (2) to highlight sites where Yale students and
        New Haven residents have changed the course of the
